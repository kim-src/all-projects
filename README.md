...
- 더 나아가면 웹 정보를 수집하는 자동화 프로그램 개발에도 활용될 수 있을 것 같습니다.
- 또는 검색 엔진 구축 프로그램 개발에 활용될 수 있을 것 같습니다.
- 그리고 웹 정보를 수집하는 자동화 프로그램 개발에도 활
- 그런데 웹 데이터 분석
 관점에서는 웹 크롤링은 수많은 데이터 분석 방법 중 하나의 도구일뿐이었습니다.
- 
