...
#### 🔔 높은 분석 수준(개발 목적 내용)
- 싱크홀의 유무를 파악하기 위해서는 조사된 도로의 길이만큼 수집된 방대한 데이터를 분석해야 됩니다.
- 

싱크홀을 지칭하는 다양한 GPR 데이터 형태를 
- 그런데 싱크홀을 지칭하는 GPR 데이터의 형태는 도로 하부에 있는 다양한 것들과 비슷합니다.
- 특히 수많은 자갈과 복잡하게 얽힌 다양한 관로들의 데이터 형태와 비슷합니다.
- 그래서 조사된 길이만큼 수집된 방대한 데이터에서 싱크홀 데이터 형태를 구분해내야 됩니다.
